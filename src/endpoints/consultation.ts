...
function response(
	...
	*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:1.5rem;background:#eaefef;color:#25343f;font-family:system-ui,sans-serif}
	main{width:min(100%,38rem);padding:clamp(1.5rem,5vw,3rem);border:2px solid #25343f;background:#bfc9d1;box-shadow:7px 7px 0 #25343f}h1{margin:0 0 1rem;font-size:clamp(2rem,8vw,3.5rem);line-height:1}p{line-height:1.6}a{display:inline-block;min-height:44px;margin-top:1rem;padding:.75rem 1rem;border:2px solid #25343f;background:#ff9b51;color:#25343f;box-shadow:5px 5px 0 #25343f;font-weight:800}
