...
function response(
	...
	*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:1.5rem;background:#eeece6;color:#011627;font-family:system-ui,sans-serif}
