...
<style>
	...
	input, textarea { width: 100%; min-width: 0; box-sizing: border-box; border: 1px solid var(--colour-support); border-radius: 2px; background: var(--colour-background); color: var(--colour-text); font: inherit; font-size: 1rem; padding: .75rem .8rem; outline: none; }
	input { min-height: 3rem; } textarea { min-height: 5.5rem; resize: vertical; line-height: 1.45; }
	input:focus, textarea:focus { border-color: var(--colour-text); outline: 3px solid var(--colour-accent); outline-offset: 2px; } [aria-invalid='true'] { border-color: var(--colour-error); }
	...
	button[type='submit']:focus-visible, .copy:focus-visible { outline: 3px solid var(--colour-accent); outline-offset: 3px; } button:disabled { cursor: wait; opacity: .7; }
