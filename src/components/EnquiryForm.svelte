...
<style>
	form { position: relative; padding: clamp(1rem, 3vw, 1.5rem); border: 2px solid #242126; background: #fffdfa; color: #242126; box-shadow: 7px 7px 0 #242126; }
	.fields { display: grid; grid-template-columns: minmax(0, .75fr) minmax(0, 1.25fr); align-items: start; gap: .9rem 1rem; }
	...
	small, .error { color: #8b1919; font-size: .76rem; } .help { color: #625c64; }
	button[type='submit'] { display: flex; justify-content: center; align-items: center; gap: 1rem; width: 100%; min-height: 3.15rem; margin-top: 1rem; padding: .8rem 1rem; border: 2px solid #242126; border-radius: 2px; background: #242126; color: #fffdfa; box-shadow: 5px 5px 0 #f27ab5; font: inherit; font-weight: 800; cursor: pointer; }
	...
	.status { min-height: 1.2em; margin: .9rem 0 0; font-size: .8rem; line-height: 1.45; } .success { color: #126044; font-weight: 750; }
	.copy { min-height: 44px; margin-top: .4rem; padding: .65rem .2rem; border: 0; background: transparent; color: #242126; font: inherit; font-size: .78rem; font-weight: 750; text-decoration: underline; cursor: pointer; }
	...
	.delivery-note, .privacy, .no-script { margin: .9rem 0 0; color: #625c64; font-size: .76rem; line-height: 1.5; } .privacy a { color: #242126; font-weight: 700; }
	@media (max-width: 36rem) { .fields { grid-template-columns: 1fr; } .wide { grid-column: auto; } input, textarea { font-size: 16px; } }
</style>
